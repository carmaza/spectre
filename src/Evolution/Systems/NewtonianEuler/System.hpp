...
template <size_t Dim, typename EquationOfStateType, typename SourceTermType>
struct System {
  ...
  using volume_sources = ComputeSources<SourceTermType>;

  using compute_time_derivative = ConservativeDuDt<System>;

  // Source for MassDensityCons vanishes.
